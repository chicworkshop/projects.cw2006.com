...
if(!isset($_SESSION['id'])){
  ...
  $to=$friendemail;
   $subject=$firstname."為你送上幸運曲奇";
  $body=file_get_contents('email_message_002.html');
...
// Conversion Name:Finish Page_cn
// INSTRUCTIONS
...
//<![CDATA[
document.write('<scr'+'ipt src="HTTP://bs.serving-sys.com/BurstingPipe/ActivityServer.bs?cn=as&amp;ActivityID=19328&amp;rnd=' + ebRand + '"></scr' + 'ipt>');
//]]>
</script>
<noscript>
<img width="1" height="1" style="border:0" src="HTTP://bs.serving-sys.com/BurstingPipe/ActivityServer.bs?cn=as&amp;ActivityID=19328" />
</noscript>
<div id="wrapper">
	<div id="container">
		...
		<div id="main">
			...
			<table width="420" border="0" align="center" cellpadding="0" cellspacing="0" class="tblNormal">
				<tr>
					<td align="center"><a href="index.php"><img src="images/btn_send_to_more.png" alt="為更多親友送上幸運曲奇 " width="300" height="20" border="0" /></a></td>
				</tr>
				<tr>
					<td align="center"><a href="http://www.emirates.com/hk/English/destinations_offers/special_offers/book_online_and_win_two_tickets_to_bangkok/book_online_and_win_two_tickets_to_bangkok.aspx"><img src="images/btn_learn_more.png" alt="試試運氣，贏取免費機票前往曼谷" width="300" height="20" border="0" /></a></td>
				</tr>
			</table>
			<p></p>
			<p></p>
