...
<!--[if gt IE 9]><!--> <html> <!--<![endif]-->
    <head>
        {MobileAppHeaders}
        <meta charset="utf-8">
        <meta name="google-site-verification" content="5fjBqTN41xUQb1_3VD5wFku10qwTLHdtB732v3Clo04" />
        ...
        <!--<link rel="stylesheet" href="http://static.tumblr.com/qoh7wg9/aXAo98vg7/main-min.css">-->
        <link rel="stylesheet" href="https://duncantang.github.io/Temp/cw-tumblr.css">
    ...
    <body data-urlencoded-name="{URLEncodedName}" class="{select:Layout}{block:IndexPage} index-page{/block:IndexPage}{block:PermalinkPage} permalink{/block:PermalinkPage}{block:LikesPage} likes-page{/block:LikesPage}{block:FollowingPage} following-page{/block:FollowingPage}{block:SearchPage} search-page{block:NoSearchResults} no-results{/block:NoSearchResults}{block:NoLikes} no-likes{/block:NoLikes}{block:NoPosts} no-posts{/block:NoPosts}{block:NoFollowing} no-following{/block:NoFollowing}{/block:SearchPage}{block:HideHeaderImage} no-header-image{/block:HideHeaderImage}{block:NoStretchHeaderImage} contain-header-image{/block:NoStretchHeaderImage}{block:IfRelatedPosts} display-related-posts{/block:IfRelatedPosts}">
                                    ...
                                    <nav class="nav-menu">
                                        <ul class="inline-nav">
                                            <li class="nav-item nav-item--archive">
                                                <a href="http://www.chicworkshop.com" class="label">Home</a>
                                            </li>
                                            <li class="nav-item nav-item--archive">
                                                <a href="http://www.chicworkshop.com/portfolio" class="label">Portfolio</a>
                                            </li>
                                            <li class="nav-item nav-item--archive">
                                                <a href="http://www.chicworkshop.com/content/about-us" class="label">About Us</a>
                                            </li>
                                            {block:HasPages}
                                                {block:Pages}
                                            ...
                                            {block:ShareFollowing}
                                                <li class="nav-item nav-item--following">
                                                    <a href="/following" class="label">{lang:Following}</a>
                                                </li>
                                            {/block:ShareFollowing}
                                            <li class="nav-item nav-item--archive">
                                        ...
                                        <footer class="post-footer">
                                            ...
                                            <section class="post-controls">
                                                <div class="controls-wrapper">
                                                    ...
                                                    <div class="control like-control"><a href="{Permalink}" class="share-item permalink"><i class="fa fa-link" aria-hidden="true"></i></a></div>
                                                </div>
                                            </section>
                                        </footer>
                                    </section>
        ...
        <script src="http://static.tumblr.com/27gzhx7/xXvob1jan/main-min.js"></script>
