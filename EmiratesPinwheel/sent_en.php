...
if(!isset($_SESSION['id'])){
  ...
  $to=$friendemail;
  $subject=$firstname." has sent you a pinwheel";
  $body=file_get_contents('email_message_en_001.html');
...
<body>
<div id="wrapper">
	<div id="container" style="background: url(images/pageBg_sent_en.jpg) no-repeat;height: 365px;">
		<div id="pageTitle"></div>
		<div class="sentbtn"> <a  href="index_en.php"><img src="images/spacer.gif" alt="" width="540" height="35" /></a>
			<div class="sentbtn"><a href="http://www.emirates.com/cn/english/destinations_offers/special_offers/book_onlin_and_win/book_online_and_win_skywards_miles.aspx?cid=114941"><img src="images/spacer.gif" alt="" width="540" height="35" /></a></div>
			<div id="footer"></div>
		</div>
	</div>
</div>
